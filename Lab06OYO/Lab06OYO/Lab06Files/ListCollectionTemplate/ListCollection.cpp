...
//****************
template<class T>
void ListCollection<T>::resize(int a)
{
    int *arr = nullptr;
    arr = new int[a];
...
//**************************
template<class T>
void ListCollection<T>::setElement(int position, int element)
{
    if (isValid(position))
...
//******************
template<class T>
int ListCollection<T>::getElement(int position) const
{
    if (isValid(position))
...
//******************************
template<class T>
const ListCollection<T> ListCollection::operator=(const ListCollection &right)
{
    delete[] list;
...
//*************************************************
template<class T>
const ListCollection<T> ListCollection::operator+(const ListCollection &right) // concatenates two lists
{
